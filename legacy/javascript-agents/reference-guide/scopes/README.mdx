...
![](</images/legacy/javascript-agents/screenshot 2019-08-13 at 11.54.36.png>)
...
![](</images/legacy/javascript-agents/screenshot 2019-08-21 at 10.34.44.png>)

If you set up the following scope...

![](</images/legacy/javascript-agents/image (294).png>)
...
![After the scope has been set up](</images/legacy/javascript-agents/image (295).png>)
...
![](</images/legacy/javascript-agents/image (357).png>)
...
![](</images/legacy/javascript-agents/image (358).png>)

Using the above scope, the above user would see **1**, **2** but not **3**:

![](</images/legacy/javascript-agents/screenshot 2020-04-15 at 18.58.32.png>)
