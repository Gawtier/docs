...
![](/images/legacy/javascript-agents/deploy-on-aws-key-pair.png)
...
![](/images/legacy/javascript-agents/deploy-on-aws-security-group.png)
...
![](/images/legacy/javascript-agents/deploy-on-aws-alb-regions.png)

- Remove default security group and select the group associated to the newly created instance.

![](/images/legacy/javascript-agents/deploy-on-aws-alb-security.png)

- Add an HTTPS listener and choose previously created target group and certificate.

![](/images/legacy/javascript-agents/deploy-on-aws-alb-https-listener.png)
